...
\begin{figure}[h!]
    ...
    \label{leg_map}
        \includegraphics[width = 13cm]{/git_repositories/LegislativeViolence/PaperNamed/incidence_map.png}
\end{figure}
...
\begin{figure}[t]
    ...
    \includegraphics[width = \textwidth]{/git_repositories/LegislativeViolence/PaperNamed/figure/corScatter.png}  
