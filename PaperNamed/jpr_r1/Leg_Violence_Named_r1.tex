...
\hline
(Intercept)             & $-3.09^{***}$ & $-2.70^{***}$ & $-4.95$      & $-1.83^{***}$ & $-2.29^{***}$ & $-1.81^{***}$ & $-1.42^{*}$   & $-1.75^{***}$ \\
                        & $(0.16)$      & $(0.65)$      & $(2.83)$     & $(0.52)$      & $(0.66)$      & $(0.48)$      & $(0.62)$      & $(0.50)$      \\
Low Disproportionality  & $-0.45$       & $-0.77^{**}$  & $-0.55$      & $-0.65^{*}$   & $-0.72^{*}$   & $-0.68^{*}$   & $-0.64^{*}$   & $-0.55^{*}$   \\
                        & $(0.25)$      & $(0.26)$      & $(0.29)$     & $(0.30)$      & $(0.36)$      & $(0.27)$      & $(0.27)$      & $(0.28)$      \\
Dem. Age                & $-0.01^{*}$   & $-0.02^{**}$  & $-0.02^{**}$ & $-0.01^{*}$   & $-0.01^{*}$   & $-0.02^{**}$  & $-0.02^{***}$ & $-0.02^{*}$   \\
                        & $(0.00)$      & $(0.01)$      & $(0.01)$     & $(0.01)$      & $(0.01)$      & $(0.01)$      & $(0.01)$      & $(0.01)$      \\
Majority Size           &               & $-0.02^{**}$  & $-0.03^{**}$ & $-0.02^{**}$  & $-0.01$       & $-0.02^{**}$  & $-0.03^{**}$  & $-0.03^{**}$  \\
                        &               & $(0.01)$      & $(0.01)$     & $(0.01)$      & $(0.01)$      & $(0.01)$      & $(0.01)$      & $(0.01)$      \\
Leg. Immunity           &               & $-0.23$       &              &               &               &               &               &               \\
                        &               & $(0.26)$      &              &               &               &               &               &               \\
PR Electoral System     &               & $1.33^{**}$   &              &               &               &               &               &               \\
                        &               & $(0.45)$      &              &               &               &               &               &               \\
