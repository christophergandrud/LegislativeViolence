...
\hline
                        & A1 & A2 & A3 & A4 & A5 & A6 \\
\hline
(Intercept)             & $-3.05^{***}$ & $-1.41$       & $-8.45$      & $-1.31^{*}$  & $-1.74^{*}$  & $-1.94^{*}$ \\
                        & $(0.20)$      & $(0.79)$      & $(5.61)$     & $(0.61)$     & $(0.78)$     & $(0.95)$    \\
Low Disproportionality  & $-0.91^{**}$  & $-1.33^{***}$ & $-1.89^{**}$ & $-1.17^{**}$ & $-1.10^{**}$ & $-0.92^{*}$ \\
                        & $(0.34)$      & $(0.36)$      & $(0.62)$     & $(0.36)$     & $(0.37)$     & $(0.36)$    \\
...
PR Electoral System     &               & $1.07^{*}$    &              &              &              &             \\
                        &               & $(0.51)$      &              &              &              &             \\
Single Party Gov.       &               & $-0.47$       &              &              &              &             \\
                        &               & $(0.32)$      &              &              &              &             \\
Self Expression         &               &               & $5.23$       &              &              &             \\
                        &               &               & $(4.30)$     &              &              &             \\
Ethnic Frac.            &               &               & $1.08$       &              &              &             \\
                        &               &               & $(1.13)$     &              &              &             \\
Federal                 &               &               &              & $0.94^{*}$   & $0.91^{*}$   &             \\
...
GDP per Capita          &               &               &              &              &              & $0.01$      \\
                        &               &               &              &              &              & $(0.03)$    \\
\hline
AIC                     & 416.23        & 400.09        & 196.47       & 368.50       & 347.87       & 371.65      \\
BIC                     & 432.89        & 438.84        & 223.83       & 401.12       & 380.32       & 404.34      \\
Log Likelihood          & -205.12       & -193.05       & -92.24       & -178.25      & -167.94      & -179.82     \\
Deviance                & 410.23        & 386.09        & 184.47       & 356.50       & 335.87       & 359.65      \\
...
\hline
                        & B1 & B2 & B3 & B4 & B5 & B6 \\
\hline
(Intercept)             & $-2.91^{***}$ & $-1.09$      & $-9.72$      & $-1.25$      & $-1.66^{*}$ & $-2.28^{*}$ \\
                        & $(0.22)$      & $(0.81)$     & $(5.87)$     & $(0.64)$     & $(0.84)$    & $(1.01)$    \\
Low Disproportionality  & $-0.76^{*}$   & $-1.08^{**}$ & $-1.68^{**}$ & $-1.05^{**}$ & $-0.98^{*}$ & $-0.84^{*}$ \\
                        & $(0.36)$      & $(0.38)$     & $(0.64)$     & $(0.39)$     & $(0.39)$    & $(0.38)$    \\
Dem. Age                & $-0.02^{*}$   & $-0.03^{**}$ & $-0.02$      & $-0.03^{**}$ & $-0.03^{*}$ & $-0.03^{*}$ \\
...
GDP per Capita          &               &              &              &              &             & $0.03$      \\
                        &               &              &              &              &             & $(0.03)$    \\
\hline
AIC                     & 346.14        & 335.86       & 159.52       & 303.85       & 283.01      & 308.45      \\
BIC                     & 362.03        & 372.81       & 185.36       & 334.93       & 313.85      & 339.67      \\
Log Likelihood          & -170.07       & -160.93      & -73.76       & -145.92      & -135.50     & -148.22     \\
Deviance                & 340.14        & 321.86       & 147.52       & 291.85       & 271.01      & 296.45      \\
