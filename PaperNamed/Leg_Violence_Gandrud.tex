...
%%%%%%% Title Page %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Two Sword Lengths: Violence in Competitively Elected National Legislatures}
...
To be able to more closely and robustly investigate these findings I use incidences of legislative brawls in competitively elected legislatures per country-year as the dependent variable in a series of rare events logistic regression models \citep{KingRareEvents2001, KingRareEventsPA2001}. Data on whether or not a legislature was competitively elected is from the DPI {\emph{Legislative Indices of Electoral Competitiveness}} variable.\endnote{Specifically, I kept only legislatures that they code as having elections where multiple parties won seats.} Due to a lack of data on some of the co-variates discussed below I also constricted the data to before 2010. This reduced the number of legislative violence incidences from 88 to 69. Full replication data and code used for all of the analyses can be found in this paper's source code files.\endnote{Full replication files can be found at \url{https://github.com/christophergandrud/LegislativeViolence}.}
...
I observed relatively few incidences of violence in the 1980s.\endnote{There were only 8 observed incidence before 1990.} This is probably because news articles from before the 1990s have not been made available on the internet with the same frequency as those written from the 1990s. To examine any estimation biases this sampling bias might create I ran the regressions on a further constricted sample of elected legislatures. The sample included country-years with elected legislatures from 1990.\endnote{For prior correction in the full sample of competitively elected legislatures I used the existing proportion of all observations with legislative violence in the time constricted sample 1.7 percent of observations up until 2010 had violence ($\tau = \frac{69}{3347} = 0.021$). for prior correction in the rare events logistic regressions \citep[see][]{KingRareEventsPA2001}. I used the observed number of violent incidences from 1990. There were 61 observed incidences of violence and 2778 country-years from 1990 through 2009 in the sample, so: $\tau = \frac{61}{2531} = 0.023$.} The results were broadly similar across the different samples. 
...
\hline
                       & A1 & A2 & A3 & A4 & A5 \\
\hline
(Intercept)            & $-3.04^{***}$ & $-1.19$       & $-7.02$      & $-1.23$           & $-1.51$      \\
                       & $(0.20)$      & $(0.80)$      & $(5.46)$     & $(0.92)$          & $(0.96)$     \\
Low Disproportionality & $-0.99^{**}$  & $-1.42^{***}$ & $-2.28^{**}$ & $-1.17^{**}$      & $-1.02^{**}$ \\
                       & $(0.35)$      & $(0.37)$      & $(0.75)$     & $(0.39)$          & $(0.37)$     \\
Dem. Age               & $-0.02^{*}$   & $-0.02^{*}$   & $-0.02$      & $-0.02^{*}$       & $-0.02^{*}$  \\
                       & $(0.01)$      & $(0.01)$      & $(0.01)$     & $(0.01)$          & $(0.01)$     \\
Majority Size          &               & $-0.04^{***}$ & $-0.04^{*}$  & $-0.03^{**}$      & $-0.03^{**}$ \\
                       &               & $(0.01)$      & $(0.02)$     & $(0.01)$          & $(0.01)$     \\
Leg. Immunity          &               & $-0.54$       &              &                   &              \\
                       &               & $(0.34)$      &              &                   &              \\
...
GDP per Capita         &               &               &              &                   & $0.01$       \\
                       &               &               &              &                   & $(0.03)$     \\
\hline
AIC                    & 404.54        & 386.29        & 183.09       & 335.92            & 358.57       \\
BIC                    & 421.07        & 424.70        & 210.14       & 384.21            & 391.00       \\
Log Likelihood         & -199.27       & -186.14       & -85.55       & -158.96           & -173.29      \\
\hline
...
{\scriptsize{
    ...
    Parliamentary is the is the reference category for government system variables (Mixed Assembly-Elected Presidential and Parliamentary). \\
}}
\end{table}
...
\hline
                       & B1 & B2 & B3 & B4 & B5 \\
\hline
(Intercept)            & $-2.91^{***}$ & $-0.81$      & $-8.12$      & $-1.36$           & $-1.80$      \\
                       & $(0.22)$      & $(0.85)$     & $(5.70)$     & $(0.99)$          & $(1.03)$     \\
Low Disproportionality & $-0.85^{*}$   & $-1.18^{**}$ & $-2.07^{**}$ & $-1.06^{*}$       & $-0.95^{*}$  \\
                       & $(0.38)$      & $(0.39)$     & $(0.76)$     & $(0.42)$          & $(0.40)$     \\
...
GDP per Capita         &               &              &              &                   & $0.03$       \\
                       &               &              &              &                   & $(0.03)$     \\
\hline
AIC                    & 334.61        & 322.38       & 145.95       & 271.56            & 295.39       \\
BIC                    & 350.32        & 358.90       & 171.38       & 317.34            & 326.27       \\
Log Likelihood         & -164.31       & -154.19      & -66.97       & -126.78           & -141.70      \\
\hline
\multicolumn{6}{l}{\scriptsize{\textsuperscript{***}$p<0.001$, 
  \textsuperscript{**}$p<0.01$, 
  \textsuperscript{*}$p<0.05$}}
