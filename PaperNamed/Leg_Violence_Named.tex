...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in library(texreg): there is no package called 'texreg'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}texreg"{}}}\end{kframe}
}
\end{center}
{\scriptsize{
