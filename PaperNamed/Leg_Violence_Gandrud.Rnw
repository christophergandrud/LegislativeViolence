...
The alternation of power that generally occurs as democratic regimes survive longer may come to eventually ameliorate some of the more extreme credible commitment problems that new democracies face.\endnote{If power does not alternate, this could exacerbate credible commitment problems and eventually lead to democratic collapse.} The gaps between legislative winners' and losers' experiences in the other position at a given time tend to be much larger in new democracies. In new democracies actors simply have not had the time to learn if they can someday become winners. Losers in new democracies may not have learned that ``pretenders to office can expect to reach it, losers can expect to come back" \citep[][36]{Przeworski1991}. Losers in unfair new democracies may be more likely to believe that the costs of not changing the rules will be great, as they have not been able to fully learn if the rules will allow them to gain power. This could increase credible commitment problems. Legislators in old democracies where alternations of power have happened will have more complete information that they will be able to gain power in the future, decreasing credible commitment problems.
...
It's important to note that if legislative violence is created by credible commitment problems, where legislators are not able to commit to peaceful bargains and rules, then it is unlikely that they would be prevented from using violence due to a lack of immunity. At the best a lack of immunity would make violence more costly thus decreasing credible commitment problems, but not eliminating them.
