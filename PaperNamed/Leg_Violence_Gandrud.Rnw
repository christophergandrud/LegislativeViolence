...
I argue that fairness specifically reduces legislative credible commitment problems in at least three ways: (a) a lack of fairness indicates a potential shift in power, (b) the reputational costs of using violence will be lower.
...
Furthermore, in new democracies, as with political regime change in general, the rules of the game are in flux. This can give present winners considerable power to set the rules to their advantage. Incumbent actors or the first actors to gain power after a transition may be better able to establish unfair rules entrenching their power \cite[108]{Saideman2002} before the democratic regime has fully consolidated. This could create create more situations where credible commitment problems between the temporarily strong that are making the rules during the transition to democracy and temporarily weak, put potentially strong legislators who could gain more electoral support. 

In the early days of a democracy the legislative party system may be shifting considerably. This could mean that even if initial rules were fair, they may come to be less so. As we will see in the antebellum US example below shifting demographics and party systems dramatically altered   


Because there are so many opportunities to change the rules in new democracies there are many occasions for the majority to break their commitments to limit their power. Losers would believe that they will not be able to experience being winners in the future and will be locked out of power. They would therefore have less incentive to continue playing by the rules of the game. If commitments are not credible, then there will me many possibilities for violence. 
