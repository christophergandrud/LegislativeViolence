...
<<models, include=FALSE>>=
    ...
    leg.raw$VeryHighProp[leg.raw$disproportionality < 3] <- 1
    leg.raw$VeryHighProp[leg.raw$disproportionality >= 3] <- 0
...
<<OutTable1, warning=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
    ...
    CoefNames <- c("(Intercept)", "Low Disproportionality", 
                    ...
                    "GINI", "GDP per Capita", "Very Low Disprop.", 
                    "Dem. Age*Very Low Disprop.")
