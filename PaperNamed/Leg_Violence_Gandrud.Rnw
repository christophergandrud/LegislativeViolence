...
As we saw in Figure \ref{framework_empirical} the disproportionality measure is very highly skewed. Substantively, a one unit increase--the change over which a regression coefficient estimates there will be a change in the outcome--is not substantively meaningful. To deal with this issue, I created a higher and lower disproportionality dummy variable. County-years with disproportinality greater than or equal to the median (6) are coded as having higher disproportionality and those with scores lower than 6 are coded as having lower disproportionality.\endnote{Models were estimated with the continuous disproportionality measure. The parameter estimates were not statistically significant.}
