...
Further drawing on the international relations literature, I argue that violence in multi-party elected legislatures is often the result of the inability of legislative actors to credibly commit to follow peaceful bargaining outcomes, including non-violent legislative rules. \cite{Fearon1995} argued that when actors are not able to make credible commitments violent conflict between states is more likely \cite[see also][]{Powell2006}. If it is difficult to believe that any peaceful bargaining outcome will actually happen because bargained commitments will likely be broken, actors will instead choose violence to achieve their goals. We can extend this logic to legislatures. In multi-party elected legislatures governing majorities and the opposition--which may some day become a governing majority--need to be able to credibly commit to not simply use or remake legislative procedures in only their narrow self-interest. They need to commit to limits on their power \citep{riker1982,Gaubatz1996}, especially legislative rules and procedures that are the result of a peaceful bargaining process. If they are not able to credibly make these commitments then legislators may come to believe that disruption and violence is the best way to achieve their goals, despite its general costs and low expected utility. What makes it more or less likely for legislators to credibly limit their power, i.e. what makes the credible commitment problem more or less severe? 

Credible commitment problems are generally smaller and therefore violence is less likely when legislators in multi-party elected legislatures view parliament's procedures and their implementation as fair. I define fairness as the degree to which seats in the legislature and legislative resources, such as speaking time and committee appointments, proportionally correspond to voters' support. I argue that fairness specifically reduces legislative credible commitment problems in at least two ways: (a) a lack of fairness indicates a potential shift in power and (b) the reputational costs of using violence will be lower.

Unfair legislatures indicate the possibility for large and rapid shifts in legislative power. For example, if an electoral system that creates highly disproportionate outcomes becomes very proportional, then the winning parties are likely to change over the course of one election. The new winners could then further alter legislative procedures to benefit themselves. \cite{Powell2004} identified major commitment problems in these situations. Temporarily weak legislators--those with disproportionally fewer seats and access to legislative resource under unfair rules--need to `buy off' those that are temporarily strong--the beneficiaries of the unfair legislature--in order to avoid the strong further dramatically changing the rules to benefit themselves. Buying off in this context may simply mean agreeing to continuing rules that make the legislature unfair at the status quo level. However, because the presently weak have the potential to be much stronger, they are likely to renege on agreements that disproportionately benefit the temporarily strong. Therefore, they are unable to commit. The temporarily strong may therefore use their power to prevent the rules from becoming more fair. Both sides may therefore break the rules and possibly use violence. The winners, who are temporarily strong, may use violence to suppress the opposition. The losers may use violence to prevent the winners further power entrenchment and possibly even to force rules that would cause the power shift.  

Relatedly, legislators that use violence in unfair legislatures may have lower reputational costs because legislators and their supporters view the rules as unfair and illegitimate. Perceived fairness has been shown to be an important component of people's perceptions of legitimacy across a wide range of settings \citep[see][]{thibaut1975,Tyler2001,Tyler2006}. Legislators would not suffer reputational damage from breaking unfair rules, especially from their supporters who also view the rules as unfair, as they are seen as illegitimate and not guides of `appropriate behavior'. At the same time breaking the rules in an attempt to make them more fair would be seen as legitimate action by supporters for self-interested reasons as they will clearly benefit from rule changes. Similarly legislators who benefit from an unfair legislature may also not suffer reputational damage from their supporters for self-interested reasons. Breaking rules and using violence to preserve unfair rules clearly benefits these supporters. Because the costs of breaking rules in unfair legislatures will be lower and indeed can increase benefits for both those who unfairness hurts and helps, it will be more difficult for legislators to commit to the rules.

Why do highly proportional electoral systems not create equally large credible commitment problems for legislators that would benefit from a large increase in unfairness? In other words, why would a fair legislature create an equilibrium? In very fair legislatures there is a ``fairness equilibrium'' \citep{Rabin1993}.


The simple answers are that though they would gain power from an increase in disproportionality it would be very difficult to actually do so using legislative disruption and violence and the costs of doing so would be large. Those that benefit from unfair legislatures have smaller support among the voters than those that benefit from fair rules. It would be difficult to garner enough support for changes from fair to unfair rules and they could even face large social unrest if they changed the rules in such a way that decreased the power of more popular parties. Furthermore, fairness has been shown in both theoretical and experimental research to help maintain a bargaining equilibrium, where neither side is better off cheating. 
...
Possibly the most important and easily observable component of whether or not legislators view their legislature as fair is the proportionality of the election that allocated its seats and therefore the control of its procedures. I have already argued that disproportional electoral outcomes create credible commitment problems as they create the potential for shifts in power and reduce reputational costs to using violence. At what observable levels of disproportionality would we expect to see more violence? At most levels of disproportionality there will be credible commitment problems, because there will be legislators who benefit for an increase in proportionality. It is only when there is closer to perfectly proportional electoral outcomes that legislators can credibly commit to following peaceful bargaining outcomes as the gains from increasing proportionality are very small or virtually none existent.

The reputational damage of committing violence is also potentially very high in systems with highly proportional electoral outcomes. \cite{Marien2011} found that there was a curvilinear relationship between proportional electoral outcomes and citizens' political trust. Feelings of political trust were highest with very proportional outcomes\endnote{The most trusting societies had Gallagher disproportionality scores of close to 1. See the discussion below for further details about this measure.} as well as disproportional or majoritarian systems. Countries in the middle had the lowest trust.\endnote{Outcomes in the middle may be a ``bastard-producing hybrid'' \citep[74]{Sartori1994} that combines the defects of both highly proportional and disproportional outcomes.} Voters and legislators in high proportionality countries may therefore view their legislatures as very legitimate and impose reputational costs on violent legislators. Should we also expect a similar curvilinear relationship for fairness and reputational costs? Probably not. Voters and legislators in high proportionality countries view their legislatures as very fair and legitimate and impose reputational costs on violent legislators. However, Merien argues that high voter trust in very disproportionate countries is caused not by fairness, but by high accountability. Disproportional majoritarian elections produce highly accountable legislatures where citizens feel a strong sense of control over their politicians \citep{Aarts2008,CHO2012}. Though this characteristic may please voters in general, for the reasons discussed above legislators and their supporters who stand to gain or lose from an increase of proportionality will be less likely to impose reputational costs on violent legislators.
...
Also, in the relatively early days of a democracy the legislative party system may be shifting considerably \cite[see][161 for a review]{Mainwaring2007b}\endnote{\cite{Mainwaring2007b} argue that it is the time period when democracy was created that is associated with party volatility rather than the number of years a country is democratic. However, their analysis they base this claim on is highly problematic because (a) they arbitrarily limit the democracy years variable to 30, ruling out effects beyond 30 years and (b) include this variable in the same models as the highly correlated democratic age variable which can lead to unreliable coefficient estimates.} possibly as politicians work out electoral coordination problems \citep[e.g.]{cox1997}. Even if initial rules were fair, they may quickly become less so as the party system changes. As we will see in the antebellum US example below shifting demographics and the party system generally dramatically altered the fairness of the distribution of power in the US Senate between pro and anti-slavery senators. Because of the instability of new party systems, there is a greater likelihood that legislatures could become unfair leading to credible commitment problems and violence.

The alternation of power that generally occurs the longer a democratic regime survives may come to eventually ameliorate some of the more extreme credible commitment problems that new democracies face. The gaps between legislative winners' and losers' experiences in the other position at a given time tend to be much larger in new democracies. In new democracies actors simply have not had the time to learn that they can someday become winners. Losers in new democracies may not have learned that ``pretenders to office can expect to reach it, losers can expect to come back" \citep[][36]{Przeworski1991}. Losers in unfair new democracies may be more likely to believe that the costs of not changing the rules will be great as they have not been able to fully learn if the rules will allow them to gain power. Legislators in old democracies where alternations of power have happened will have more complete information about how unfair the rules are in terms of whether or not they will be allowed to gain legislative power.
