...
To examine the relationships between societal-level values and legislative violence I rely primarily on data from the World Values Survey \citeyearpar{WVS2009}. Over the course of his research, Ingelhart has found that his composite {\emph{self-expression}} indicator is the best way to capture cultural and normative differences between democracies and non-democracies. Societies have high self-expression scores if they emphasize ``liberty and participation, public self-expression, tolerance of diversity, interpersonal trust, and life satisfaction" \citep[64]{Inglehart2003}. So I include the self-expression variable from the World Values Survey. See the Supplementary Materials for details. In earlier versions of the models I also included components of this variable. However, they were either never statistically significant or produced unintelligible and unstable results.

Please see the Supplementary Materials for details of the other variables included in the regression models to help avoid omitted variable bias. These include: percentage of women in parliament, the national murder rate, government fractionalization, whether or not there is a single-party government, effective number of parliamentary parties, whether or not a country had a federal system, ethnic fractionalization, the Gini coefficient, and gross domestic product per capita.
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=0.8\linewidth]{figure/predProb-1} 
